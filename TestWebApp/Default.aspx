...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        ...
        <p class="lead">
            <asp:Image ID="Image1" runat="server" ImageUrl="https://www.capgemini.com/sites/all/themes/capgemini/logo.png" />
        </p>
        <p><a href="hondje/doggy.aspx" class="btn btn-primary btn-lg">Learn more &raquo;</a></p>
    </div>
